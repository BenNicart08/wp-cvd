        ...
        <div class="homebanner__wrapper">
          <div class="homebanner--text">
            ...
            <p>
              ...
              fugiat amet. Corporis dolore id blanditiis, nisi, dolores nostrum
              eos veritatis aliquid fuga dolor sapiente vitae, corrupti cumque!
              Autem, illo?
            </p>
            <a href="<?php echo site_icon_url( '/about' )?>" class="btn bg-primary">Learn More</a>
          </div>
